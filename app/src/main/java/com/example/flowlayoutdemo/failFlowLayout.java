 ...
 * 自定义流式布局
 */
public class failFlowLayout extends ViewGroup {
    public failFlowLayout(Context context) {
        this(context, null);
    }

    public failFlowLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public failFlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        //不使用super.onMeasure(widthMeasureSpec, heightMeasureSpec);
        //获取设置的宽高的模式和具体的值
        initMeasureParams();
